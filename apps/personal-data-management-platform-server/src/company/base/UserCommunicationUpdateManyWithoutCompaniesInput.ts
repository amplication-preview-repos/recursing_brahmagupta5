...
@InputType()
class UserCommunicationUpdateManyWithoutCompaniesInput {
...
export { UserCommunicationUpdateManyWithoutCompaniesInput as UserCommunicationUpdateManyWithoutCompaniesInput };
